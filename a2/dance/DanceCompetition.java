...
public class DanceCompetition {
    ...
    public DanceCompetition(double poppingDance, double hipHop) {
        ...
        poppingDanceFraction = poppingDance;
        hiphopFraction = hipHop;
    }
