...
public class Competitor {
    ...
    public Competitor() {
        //CODE HERE
        poppingDanceScores = new ScoreKeeper();
        hipHopDanceScores = new ScoreKeeper();
    ...
    public String getAlias() {
        //CODE HERE
        return aliasName; // TODO: Change me
    }
    ...
    public void setPoppingDanceScore(double[] scores) {
        //CODE HERE
        poppingDanceScores.setScores(scores);
    }
    ...
    public void setHipHopDanceScore(double[] scores) {
        //CODE HERE
        hipHopDanceScores.setScores(scores);
    }
    ...
    public void printPoppingDanceScore() {
        //CODE HERE
        System.out.println(Arrays.toString(poppingDanceScores.getScores()));
    }
    ...
    public void printHipHopDanceScore() {
        //CODE HERE
        System.out.println(Arrays.toString(hipHopDanceScores.getScores()));
    }
    ...
    public double getPoppingDanceAverage() {
        //CODE HERE
        return poppingDanceScores.getCalibratedAverage(); // TODO: CHANGE ME
    }
    ...
    public double getHipHopDanceAverage() {
        //CODE HERE
        return hipHopDanceScores.getCalibratedAverage(); // TODO: CHANGE ME
    }
    ...
    public double getTotalDanceScore() {
        ...
        return p * getPoppingDanceAverage() + h * getHipHopDanceAverage();
    }
